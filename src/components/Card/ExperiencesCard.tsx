        ...
        <div className="flex flex-col border-l-4 border-[#B729DB] pl-8 space-y-20">
            {dados.map((experience) => (
                <div key={experience.id} className="relative">
                    ...
                    <div className="bg-card p-6 sm:p-10 rounded-3xl shadow-lg flex flex-col mr-0 sm:mr-20">
                        ...
                        <div className="flex flex-col sm:flex-row items-stretch gap-10">
                            ...
                            />
                            <div className="flex flex-wrap content-center justify-center gap-4 bg-card-language w-full sm:w-1/2 p-4 rounded-2xl">
                                {experience.technologies.map((tech, index) => (
                                    <div
                                        key={index}
                                        className="flex gap-2 bg-card px-5 py-2 rounded-4xl items-center whitespace-nowrap"
                                    >
